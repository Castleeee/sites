...
13. 进入控制面板,修改
    ...
    - 注册表关闭安全警告添加以下常用文件名，直接在/d后面跟上就行
```
//命令
//文件名
```
14. 编辑右下角快捷方式
15. 开启WSL，链接<a href="https://docs.microsoft.com/zh-cn/windows/wsl/install-win10?redirectedfrom=MSDN">在这</a>，配置WSL在这。
16. 安装MS商店原生应用，安装迅雷极速版，无广告winrar，everything，autoHotKey，SumatraPDF，Acrobat，设置火狐，设置Chrome，安装office和visio，QQ+Tim
## 魔改默认
### 默认文件app
1. pdf默认使用SumatraPDF
2. 视频类默认用自带的movie
