...
```py
a=np.array([i for i in range (1,10)])#数组
b=np.arange(1,10,2,dtype=np.float16)#顺序生成数组
```

</details>    

<details>
  <summary><B><I style="cursor:pointer; color: #0e5870"">Click to See More Result</I></B></summary>
...
```
<details>
<summary><B><I style="cursor:pointer;>Click to See More Result</I></B></summary>
